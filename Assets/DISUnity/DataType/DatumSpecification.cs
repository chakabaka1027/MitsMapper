...
namespace DISUnity.DataType
{
	...
	/// </summary>
	[Serializable]
	public class DatumSpecification : DataTypeBaseSimple
    {
		#region Properties
		...
		[SerializeField]
		protected FixedDatumCollection fixedDatums = new FixedDatumCollection();

		[SerializeField]
		protected VariableDatumCollection variableDatums = new VariableDatumCollection();
