...
namespace DISUnity.DataType
{
    ...
    /// <size>4 bytes</size>
    [Serializable]
    public class SimulationAddress : DataTypeBaseSimple
    {
        #region Properties
        ...
        /// </summary>
        /// <param name="br"></param>
        public SimulationAddress( BinaryReader br )
        {
            Decode( br );
        }
        ...
        {
            isDirty = true;
            siteID = br.ReadUInt16();
            applicationID = br.ReadUInt16();            
        }
        ...
        {
            bw.Write( ( ushort )siteID );
            bw.Write( ( ushort )applicationID );
            isDirty = false;
        }
        ...
        {
            return string.Format( "{0, -20} : {1} : {2}\n", "SimulationAddress", siteID, applicationID );
        }
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        public bool Equals( SimulationAddress b )
        {
            if( siteID        != b.siteID        ) return false;
            if( applicationID != b.applicationID ) return false;
            return true;
        }
        ...
        /// <param name="b"></param>
        /// <returns></returns>
        public static bool Equals( SimulationAddress a, SimulationAddress b )
        {
            return a.Equals( b );
        }
